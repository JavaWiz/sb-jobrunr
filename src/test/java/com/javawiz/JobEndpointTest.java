...
public class JobEndpointTest {
    ...
    public void givenEndpoint_whenJobEnqueued_thenJobIsProcessedWithin30Seconds() {
        ...
        await()
                ...
                .until(() -> storageProvider./*.countJobs(StateName.SUCCEEDED)*/getBackgroundJobServers().size() == 1);
    }
    ...
    public void givenEndpoint_whenJobScheduled_thenJobIsScheduled() {
        ...
        await()
                .atMost(30, TimeUnit.SECONDS)
                .until(() -> storageProvider/*.countJobs(StateName.SCHEDULED)*/.getBackgroundJobServers().size() == 1);
    }
